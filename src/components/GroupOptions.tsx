    ...
    >
      ...
      <Stack spacing={2}>
        ...
        <Box sx={{ pt: 1.5, borderTop: `1px solid ${alpha('#ffffff', 0.08)}` }}>
          <Typography variant="caption" sx={{ color: alpha('#ffffff', 0.7), mb: 0.8, display: 'block', fontWeight: 600 }}>
            {t('snapshot.search')}
          </Typography>
          ...
          <Stack spacing={1.2}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
              <FormControl size="small" fullWidth>
                <Select
                  ...
                  sx={{ color: alpha('#ffffff', 0.8), fontSize: 12, '& fieldset': { borderColor: alpha('#ffffff', 0.12) } }}
                >
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
              <Box sx={{ display: 'flex', gap: 0.5 }}>
                <TextField
                  ...
                  sx={{
                    flex: 1,
                    '& .MuiOutlinedInput-root': { color: alpha('#ffffff', 0.8), fontSize: 12, '& fieldset': { borderColor: alpha('#ffffff', 0.12) } }
                  }}
                />
                <FormControl size="small" sx={{ minWidth: 60 }}>
                  <Select
                    ...
                    sx={{ color: alpha('#ffffff', 0.8), fontSize: 11, '& fieldset': { borderColor: alpha('#ffffff', 0.12) } }}
                  >
            ...
            <Box>
              <Typography variant="caption" sx={{ color: alpha('#ffffff', 0.6), mb: 1, display: 'block' }}>{t('snapshot.extensionFilter')}</Typography>
            ...
            <FormControlLabel
              ...
              label={<Typography variant="caption" sx={{ color: alpha('#ffffff', 0.6) }}>{t('snapshot.searchCaseSensitive')}</Typography>}
            />
          </Stack>
        </Box>
      </Stack>
